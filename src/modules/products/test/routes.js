  ...
  it('should be able to save a Product if logged in', function (done) {
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        var token = signinRes.body.loginToken;
          ...
          .end(function (productSaveErr, productSaveRes) {
            ...
            agent.get('/api/products')
              .end(function (productsGetErr, productsGetRes) {
                ...
                (products[0].name).should.match('Product name3');
                (products[0].image).should.match(product.image);
                (products[0].category).should.match(product.category);
                (products[0].prices[0].name).should.match(product.prices[0].name);
                (products[0].prices[0]._type).should.match(product.prices[0]._type);
                (products[0].prices[0].price).should.match(product.prices[0].price);

                (products[0].submenus[0]._type).should.match(product.submenus[0]._type);
                (products[0].submenus[0].name).should.match(product.submenus[0].name);

                (products[0].submenus[0].prices[0].name).should.match(product.submenus[0].prices[0].name);
                (products[0].submenus[0].prices[0]._type).should.match(product.submenus[0].prices[0]._type);
                (products[0].submenus[0].prices[0].price).should.match(product.submenus[0].prices[0].price);

                (products[0].typebranch).should.match(product.typebranch);                
              ...
              orphan.remove(function () {
                ...
                agent.post('/api/auth/signin')
                  ...
                  .end(function (err, res) {
                    ...
                    res.body.loginToken.should.not.be.empty();
                    var _token = res.body.loginToken;
                    // Get the Product
